...
import { Devolucion } from '../dtocontroller/registro_devolucion.js ';
import { Entrega } from '../dtocontroller/registro_entrega.js';
...
const DTO = (p1) =>{
    const match = {
        ...
        'cliente': Cliente,
        'empleado': Empleado,
        'registro_devolucion': Devolucion,
        'registro_entrega': Entrega,
        'reserva': Reserva,
        'sucursal_automovil': SucuAutomovil,
        'sucursal': Sucursal
    };  
